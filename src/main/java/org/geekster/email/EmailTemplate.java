...
public class EmailTemplate {
    public static void main(String[] args) {
        String fromAddress = "sankalptrimade1@gmail.com";
        String toAddress = "sankalptrimade0014@gmail.com";
        String ccAddress = "trimadeSankalp0014@gmail.com";
        String messageBody = "Hi Sushant, I am sending this mail as a demo to you. I have created a software of sending email through Java Program. I share one Attachment with you in pdf format that's my resume.";
        ...
        */
        ...
        Session session = Session.getInstance(properties, new Authenticator() {
            ...
            protected PasswordAuthentication getPasswordAuthentication() {
                return new PasswordAuthentication("sankalptrimade1@gmail.com", Constant.PASSWORD);
            }
        });
        return session;
    }
